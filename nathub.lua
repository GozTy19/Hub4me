...
local _function = {
    ["getid"] = function()
        ...
        if premium then
            ...
            elseif g == 6331902150 then return "0771107275ffabca9221c264306214f9" end -- Forsaken 
        else
            ...
            elseif g == 6331902150 then return "811768c852543782f63839177a263d53" end -- Forsaken 
        end
    end,
    ["gamename"] = function()
        local g = game.GameId
